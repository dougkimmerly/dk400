...
class UserManager:
    ...
    def delete_user(self, username: str) -> tuple[bool, str]:
        ...
        try:
            with get_cursor() as cursor:
                cursor.execute(
                    "DELETE FROM qsys.users WHERE username = %s",
                    (username,)
                )
    ...
    def get_user(self, username: str) -> Optional[UserProfile]:
        ...
        try:
            with get_cursor() as cursor:
                cursor.execute(
                    "SELECT * FROM qsys.users WHERE username = %s",
                    (username,)
                )
                row = cursor.fetchone()
                if row:
    ...
    def list_users(self) -> list[UserProfile]:
        ...
        try:
            with get_cursor() as cursor:
                cursor.execute("SELECT * FROM qsys.users ORDER BY username")
    ...
    def enable_user(self, username: str) -> tuple[bool, str]:
        ...
        try:
            with get_cursor() as cursor:
                cursor.execute("""
                    UPDATE qsys.users SET status = '*ENABLED' WHERE username = %s
                """, (username,))
    ...
    def disable_user(self, username: str) -> tuple[bool, str]:
        ...
        try:
            with get_cursor() as cursor:
                cursor.execute("""
                    UPDATE qsys.users SET status = '*DISABLED' WHERE username = %s
                """, (username,))
